        ...
        <>
          <select multiple style={{ width: "80px" }}>
            {circumOptions.map((item: string) => (
              <option key={item} id="circum" onClick={handleOnClick}>
                {item}
              </option>
            ))}
          </select>
          <select multiple style={{ width: "80px" }}>
            {emotionOptions.map((item: string) => (
              <option key={item} id="emotion" onClick={handleOnClick}>
                {item}
              </option>
            ))}
          </select>
          <select multiple style={{ width: "80px" }}>
            {peopleOptions.map((item: string) => (
              <option key={item} id="people" onClick={handleOnClick}>
                {item}
              </option>
            ))}
          </select>
          <select multiple style={{ width: "80px" }}>
            {othersOptions.map((item: string) => (
              <option key={item} id="others" onClick={handleOnClick}>
                {item}
              </option>
            ))}
          </select>
